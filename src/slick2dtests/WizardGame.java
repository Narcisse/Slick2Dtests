...
public class WizardGame extends BasicGame
{
     ...
     {
         Image [] movementUp = {new Image("data/paysan.png"), new Image("data/paysan.png")};
         Image [] movementDown = {new Image("data/paysan.png"), new Image("data/paysan.png")};
         Image [] movementLeft = {new Image("data/paysan.png"), new Image("data/paysan.png")};
         Image [] movementRight = {new Image("data/paysan.png"), new Image("data/paysan.png")};
